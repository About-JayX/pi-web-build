        ...
        <Flex
          ...
          >
            ...
            <Menu>
              ...
              <MenuList>
                <MenuItem 
                  icon={<Image src="/pi.png" alt="Pi Network" boxSize="18px" borderRadius="full" />}
                  fontWeight="500"
                ...
                <MenuItem
                  icon={<Image src="/sol.png" alt="Solana" boxSize="18px" borderRadius="full" />}
                  fontWeight="500"
              ...
              <Menu>
                ...
                <MenuList>
                  {navItem.children.map((child) => (
                    <MenuItem key={child.label} as={NextLink} href={child.href ?? '#'}>
                      <Text>{t(child.label)}</Text>
                      <Text fontSize="xs" color="gray.500">{t(child.subLabel || '')}</Text>
                    </MenuItem>
                  ))}
                </MenuList>
              </Menu>
      ...
      <Box pt={4} pb={2}>
        ...
        <Stack spacing={2}>
          <Button 
            ...
            justifyContent="flex-start"
            leftIcon={<Image src="/pis.png" alt="Pi Network" boxSize="18px" borderRadius="full" />}
            onClick={() => handleNetworkChange('Pi Network')}
            h="36px"
          >
            Pi Network
          ...
          <Button 
            ...
            justifyContent="flex-start"
            leftIcon={<Image src="/sol.png" alt="Solana" boxSize="18px" borderRadius="full" />}
            onClick={() => handleNetworkChange('Solana')}
            h="36px"
          >
            Solana
...
const MobileNavItem = ({ label, children, href, isActive, onClose }: NavItem & { isActive?: boolean, onClose: () => void }) => {
  const { isOpen, onToggle } = useDisclosure();
  const activeLinkColor = useColorModeValue('brand.primary', 'brand.light');
  const linkColor = useColorModeValue('gray.600', 'gray.200');
  const { t } = useTranslation();
