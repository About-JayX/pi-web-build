...
import { FaInfoCircle, FaWallet, FaCoins, FaUndo, FaChevronRight, FaTimes, FaPercent } from 'react-icons/fa';
...
export default function MintingForm({ token, isOpen, onClose, isModal = false }: MintingFormProps) {
  ...
  const handleCancel = () => {
    ...
    setTimeout(() => {
      // 更新钱包余额
      setWalletBalance(prev => parseFloat((prev + actualRefundAmount).toFixed(2)));
      ...
      const refundAmountFormatted = Math.floor(tokenRefundValue).toLocaleString();
  ...
  const quickSelect = (value: number) => {
    ...
    if (value > walletBalance) {
      toast({
        ...
        description: t('walletBalanceInsufficient', { balance: walletBalance, currency: currencyUnit }),
        status: "error",
        duration: 3000,
        isClosable: true,
        position: "top"
  ...
  return (
      <VStack spacing={{ base: 4, md: 6 }} align="stretch">
        {/* 金额输入 */}
        <Box>
          <Text mb={{ base: 2, md: 3 }} fontSize={{ base: "sm", md: "md" }} fontWeight="medium" color="gray.600">{t('mintingAmount')}</Text>
    <Box 
            position="relative"
      borderRadius="lg"
            overflow="hidden"
      ...
      boxShadow="md"
          >
            ...
            >
              ...
              {amount && (
                <IconButton
                  position="absolute"
                  right={{ base: currencyUnit === 'SOL' ? 24 : 16, md: currencyUnit === 'SOL' ? 28 : 20 }}
                  top="50%"
            ...
            >
              <Text fontSize={{ base: "xs", md: "sm" }} color="gray.500">
                {t('walletBalance')}: <Text as="span" fontWeight="bold" color="gray.700">{walletBalance} {currencyUnit}</Text>
              </Text>
            </Flex>
          </Box>
        </Box>
        ...
        {/* 快速选择按钮 */}
        <Flex justify="space-between" gap={{ base: 2, md: 3 }} mt={{ base: 3, md: 5 }}>
          <Button
  ...
  const renderRefundTab = () => {
    if (mintedAmount <= 0) {
      return (
        <Flex 
          ...
          m={{ base: 1, md: 2 }}
        >
          <Circle size={{ base: "60px", md: "80px" }} bg="white" mb={{ base: 4, md: 6 }} boxShadow="sm">
            <Icon as={FaCoins} boxSize={{ base: "24px", md: "32px" }} color="gray.400" />
          </Circle>
          <Text fontSize={{ base: "md", md: "lg" }} fontWeight="semibold" color="gray.700" mb={2}>{t('noMintedTokens')}</Text>
          <Text fontSize={{ base: "xs", md: "sm" }} color="gray.500" mb={{ base: 6, md: 8 }} textAlign="center">{t('refundAnytime')}</Text>
          <Button 
            bg="brand.primary"
            color="white"
            variant="solid"
    ...
    return (
      <VStack spacing={{ base: 4, md: 6 }} align="stretch" py={{ base: 2, md: 3 }}>
        {/* 退还代币输入 */}
        <Box>
          <Text mb={{ base: 2, md: 3 }} fontSize={{ base: "sm", md: "md" }} fontWeight="medium" color="gray.600">{t('refundAmount')}</Text>
          <Box 
            position="relative"
            borderRadius="lg"
            overflow="hidden"
          ...
          >
            ...
            >
              <Text fontSize={{ base: "xs", md: "sm" }} color="gray.500">
                {t('availableBalance')}: <Text as="span" fontWeight="bold" color="gray.700">{estimatedTokens} {token.symbol}</Text>
              </Text>
            </Flex>
          </Box>
        </Box>
        ...
        {isTokenRefundAmountValid() && (
          ...
          >
            <HStack justify="space-between" mb={3}>
              <Text fontSize={{ base: "sm", md: "md" }} color="gray.600">{t('feePercent')}:</Text>
              <Text fontSize={{ base: "sm", md: "md" }} color="gray.600">{getPiRefundFee()} {currencyUnit}</Text>
            </HStack>
            <HStack justify="space-between">
              <Text fontSize={{ base: "sm", md: "md" }} color="gray.600">{t('refundReceive')}:</Text>
              <Text fontWeight="bold" color="green.500" fontSize={{ base: "md", md: "lg" }}>
  ...
  const renderContent = () => (
    ...
    >
      ...
      <Tabs 
        ...
        width="100%"
      >
        <TabList bg="gray.100" p={1} borderRadius="full" mb={isModal ? 4 : { base: 6, md: 8 }} boxShadow="sm" width="100%">
          <Tab 
            borderRadius="full" 
            _selected={{ 
              bg: "brand.primary", 
